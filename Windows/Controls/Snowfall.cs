...
public class Snowfall : Canvas
{
    ...
    private void EmitSnowflake()
    {
        ...
        var xAmount = _random.Next(0 - 20, (int)ActualWidth + 20);
        var scale = ((_random.NextDouble() * 0.75) + 0.5) * ScaleFactor;
        var rotateAmount = _random.Next(-360, 360);
